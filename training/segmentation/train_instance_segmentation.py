...
def main():
    ...
    # label2id = {"background": 0, "elephant": 1}
    label2id = {"elephant": 0}
    ...
    validation_transform = A.Compose(
        [
            A.LongestMaxSize(max_size_hw=(args.image_height, args.image_width)),
            A.PadIfNeeded(min_height=args.image_height, min_width=args.image_width),
        ]
    )
