...
#   --save-jpg --jpg-interval 5 --jpg-max-count 20000
...
# python3 visualization/elephant_dashboard.py \
#   --input-dir /media/dherrera/ElephantsWD/tracking_results/tracking_w_behavior_4cams/20250729/20250729_18 \
#   --output-dashboard ./tmp/elephant_timeline_20250729.html \
#   --output-summary ./tmp/behavior_summary_20250729.csv \
#   --output-stitched-json ./tmp/stitched_results_20250729.jsonl \
#   --gap-threshold 10

# python3 visualization/generate_video.py \
#   --stitched-json ./tmp/stitched_results_20250729.jsonl \
#   --output-video ./tmp/output_video.mp4 \
#   --fps 1 \
#   --max-duration 100